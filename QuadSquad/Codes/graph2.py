...
with open("pagefaultdata_wsclock.txt",'r') as f:
    ...
    for line in Lines:
        ...
        y1.append((2*(int(line[2])))-int(line[0]))
...
with open("pagefaultdata_workingset.txt",'r') as f:
    ...
    for line in Lines:
        ...
        y2.append((2*(int(line[2])))-int(line[0]))
...
with open("pagefaultdata_aging.txt",'r') as f:
    ...
    for line in Lines:
        ...
        y3.append((2*(int(line[2])))-int(line[0]))
...
with open("pagefaultdata_CLOCK.txt",'r') as f:
    ...
    for line in Lines:
        ...
        y4.append((2*(int(line[2])))-int(line[0]))
...
with open("pagefaultdata_FIFOwithSecondChance.txt",'r') as f:
    ...
    for line in Lines:
        ...
        y5.append((2*(int(line[2])))-int(line[0]))
...
with open("pagefaultdata_NRU.txt",'r') as f:
    ...
    for line in Lines:
        ...
        y6.append((2*(int(line[2])))-int(line[0]))
...
with open("pagefaultdata_lru.txt",'r') as f:
    ...
    for line in Lines:
        ...
        y7.append((2*(int(line[2])))-int(line[0]))
...
with open("pagefaultdata_optimal.txt",'r') as f:
    ...
    for line in Lines:
        ...
        y8.append((2*(int(line[2])))-int(line[0]))
...
with open("pagefaultdata_random.txt",'r') as f:
    ...
    for line in Lines:
        ...
        y9.append((2*(int(line[2])))-int(line[0]))
...
with open("pagefaultdata_fifo.txt",'r') as f:
    ...
    for line in Lines:
        ...
        y10.append((2*(int(line[2])))-int(line[0]))
...
with open("pagefaultdata_nfu.txt",'r') as f:
    ...
    for line in Lines:
        ...
        y11.append((2*(int(line[2])))-int(line[0]))
...
plt.suptitle("Frames Vs No of Swaps")
# WsClock
axis[0, 0].plot(x1, y1)
